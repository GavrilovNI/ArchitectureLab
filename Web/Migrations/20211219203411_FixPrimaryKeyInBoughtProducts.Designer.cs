...
namespace Web.Migrations
{
    ...
    [Migration("20211219203411_FixPrimaryKeyInBoughtProducts")]
    partial class FixPrimaryKeyInBoughtProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Areas.Identity.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Web.Areas.Identity.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Web.Data.Models.BoughtProduct", b =>
                {
                    b.HasOne("Web.Data.Models.BoughtCart", "BoughtCart")
                        .WithMany("Products")
                        .HasForeignKey("BoughtCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BoughtCart");
                });
